...
{
  long long cycle;
  __asm__ __volatile__ ("rdcycle %0; add x0,x0,x0":"=r"(cycle));
...
{
  long long cycle;
  __asm__ __volatile__ ("rdinstret %0; add x0,x0,x0":"=r"(cycle));
...
{
  long long num;
  __asm__ __volatile__ ("csrr %0, mhpmcounter10":"=r"(num));
...
{
  long long cycle;
  __asm__ __volatile__ ("rdcycle %0; add x0,x0,x1":"=r"(cycle));
...
{
  long long cycle;
  __asm__ __volatile__ ("rdcycle %0; add x0,x0,x2":"=r"(cycle));
